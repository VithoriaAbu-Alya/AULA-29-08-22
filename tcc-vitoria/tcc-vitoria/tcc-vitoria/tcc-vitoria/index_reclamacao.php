...
<body>
	...
	<div class='container'>
		<fieldset>
			...
			<legend><h1>Listagem de Reclamações</h1></legend>
			...
			<form action="" method="get" id='form-contato' class="form-horizontal col-md-10">
			    ...
			    <a href='index_reclamacao.php' class="btn btn-primary">Ver Todos</a>
			</form>

			<!-- Link para página de cadastro -->
			<a href='cadastro.php' class="btn btn-success pull-right">Cadastrar Reclamações</a>
			...
			<?php else: ?>
				...
				<h3 class="text-center text-primary">Não existem reclamações cadastradas!</h3>
			<?php endif; ?>
		</fieldset>
	</div>
